...
const properties = [
  ...
  },
  {
    ...
    yearBuilt: 2018,
    type: 'Apartment',
    description: 'Elegant apartment with river views and modern amenities. Perfect for families or investors.',
    amenities: ['River View', 'Balcony', 'Gym', 'Security'],
    listingDate: '2025-12-10'
  },
  {
    id: 3,
    address: 'Svoboda Street, Haskovo',
    location: 'Haskovo',
    price: 520000,
    bedrooms: 1,
    bathrooms: 1,
  ...
  {
    id: 4,
    address: 'General Gurko Street, Gabrovo',
    location: 'Gabrovo',
    price: 295000,
    bedrooms: 1,
    bathrooms: 1,
    ...
    yearBuilt: 2020,
    type: 'Studio',
    description: 'Trendy urban studio with high ceilings and exposed brick. Walk to shops and restaurants.',
    amenities: ['High Ceilings', 'Exposed Brick', 'Hardwood Floors', 'Downtown Location'],
    listingDate: '2025-12-05'
  },
  {
    id: 5,
    address: 'Dame Gruev Street, Plovdiv',
    location: 'Plovdiv',
    price: 425000,
    bedrooms: 3,
    bathrooms: 2,
  ...
  {
    id: 6,
    address: 'Baba Tonka Street, Ruse',
    location: 'Ruse',
    price: 650000,
    bedrooms: 4,
    bathrooms: 3,
  ...
  {
    id: 7,
    address: 'Vasil Levski Street, Vidin',
    location: 'Vidin',
    price: 580000,
    bedrooms: 4,
    bathrooms: 3,
    ...
    yearBuilt: 2025,
    type: 'Apartment',
    description: 'Waterfront apartment with private beach access, perfect for water enthusiasts.',
  ...
  },
  {
    ...
    yearBuilt: 2019,
    type: 'House',
    description: 'Artist apartment with skylights, open floor plan, and plenty of natural light.',
    amenities: ['Skylights', 'Polished Concrete', 'Open Floor Plan', 'Industrial Feel'],
    listingDate: '2025-11-20'
  },
  {
    id: 10,
    address: 'Aleksandrovska Street, Burgas',
    location: 'Burgas',
    price: 465000,
    bedrooms: 1,
    bathrooms: 1,
    ...
    yearBuilt: 2013,
    type: 'Studio',
    description: 'Great studio near schools and parks with updated kitchen and bathrooms.',
  ...
  },
  {
    ...
    yearBuilt: 2011,
    type: 'Office',
    description: 'Exclusive office in the middle of the city.',
    amenities: ['Golf Course Access', 'Gated Community', 'Country Club', 'Security Gate'],
    listingDate: '2025-11-15'
  },
  {
    id: 12,
    address: 'Aleko Konstantinov Street, Varna',
    location: 'Trendy Varna',
    price: 340000,
    bedrooms: 4,
    bathrooms: 2,
    sqft: 1400,
    ...
    yearBuilt: 2021,
    type: 'Penthouse',
    description: 'Brand new modern penthouse in the heart of the trendy quarter with all contemporary features.',
  ...
  },
  {
    ...
    yearBuilt: 2018,
    type: 'Apartment',
    description: 'Industrial-chic apartment in converted warehouse with exposed beams and large windows.',
  ...
  },
  {
    ...
    yearBuilt: 2015,
    type: 'Garage',
    description: 'Elegant garage in prestigious garden district with landscaped gardens and fountain.',
  ...
  },
  {
    ...
    yearBuilt: 2016,
    type: 'House',
    description: 'Executive house in prestigious park with high-end finishes and professional landscaping.',
